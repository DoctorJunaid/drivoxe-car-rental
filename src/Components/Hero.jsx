                ...
                <div className={`relative z-10 flex min-h-screen w-full flex-col items-center justify-center gap-12 p-6 pt-10 md:flex-row md:justify-between md:px-20 ${isMobile ? 'bg-black/30' : ''}`}>
                    ...
                    <div id={"right"} className={"flex flex-col w-full max-w-sm md:w-auto items-center text-center"}>
                        ...
                        <div className={"flex flex-wrap items-center justify-center gap-3 mt-10"}>
                            {/* ... Your four buttons ... */}
                            <button className={`px-6 border-2 border-[#FD3B3B] py-3 text-xl text-[#FD3B3B] rounded-full hover:bg-[#FD3B3B] hover:text-white transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white hover:cursor-pointer ${!isMobile ? 'bg-white/20' : 'bg-[#F5F5F5]'}`}>Rent</button>
                            <button className={`px-7 border-2 border-[#FD3B3B] py-3 text-xl text-[#FD3B3B] rounded-full hover:bg-[#FD3B3B] hover:text-white transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white hover:cursor-pointer ${!isMobile ? 'bg-white/20' : 'bg-[#F5F5F5]'}`}>Buy</button>
                            <button className={`px-8 border-2 border-[#FD3B3B] py-3 text-xl text-[#FD3B3B] rounded-full hover:bg-[#FD3B3B] hover:text-white transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white hover:cursor-pointer ${!isMobile ? 'bg-white/20' : 'bg-[#F5F5F5]'}`}>Sell</button>
                            <button className={`px-5 border-2 border-[#FD3B3B] py-3 text-xl text-[#FD3B3B] rounded-full hover:bg-[#FD3B3B] hover:text-white transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white hover:cursor-pointer ${!isMobile ? 'bg-white/20' : 'bg-[#F5F5F5]'}`}>Consult</button>
                        </div>
